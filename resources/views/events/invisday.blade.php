...
@section('title', 'INVISDAY — Coming Soon')
    ...
    <div>
      <nav class="text-xs text-gray-500">
        <ol class="flex items-center gap-1">
          ...
          <li>/</li>
          <li><span class="text-gray-900 font-medium">INVISDAY</span></li>
        </ol>
      </nav>
      <h1 class="mt-2 text-2xl font-semibold text-gray-900">INVISDAY</h1>
      <p class="mt-1 text-sm text-gray-600">Halaman event INVISDAY — Coming Soon.</p>
    </div>
  </div>
    ...
    <div class="grid gap-4 md:grid-cols-3">
      <div class="md:col-span-2">
        <p class="text-sm text-gray-700">
          Informasi lengkap mengenai INVISDAY sedang kami siapkan. Pantau terus kanal resmi:
        </p>
